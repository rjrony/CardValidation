// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NoFutureDateValidator.cs">
...
namespace Infrastructure.Validation.Validators
{
    ...
    /// The DateTime date
    /// </typeparam>
    public class NoFutureDateValidator<T> : RuleValidator<T, DateTime>
    {
        ...
        public NoFutureDateValidator()
        {
            ...
            this.Message = Infrastructure.Validation.Validators.Properties.Resources.InvalidNoFutureDate;
        }
